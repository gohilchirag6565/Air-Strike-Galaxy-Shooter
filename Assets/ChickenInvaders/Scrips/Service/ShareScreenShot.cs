...
public class ShareScreenShot : MonoBehaviour 
{
	...
	public string subject = "Strike Galaxy Attack-Chicken Invaders";
	string destination;
	...
	{
		FXSound.THIS.fxSound.clip = FXSound.THIS.Camera;
		shareScore = "" +PlayerPrefs.GetInt ("BestScoreAll");
	...
	intentObject.Call<AndroidJavaObject>("putExtra", intentClass.GetStatic<string>("EXTRA_TEXT"),  "Join this exciting battle with me right now,my friends|Strike Galaxy Attack-Chicken Invaders- |My Best Score| " + shareScore+" |"+ " download " + AndroidUrl);
		...
		void ShareMethode()
		{
			...
			{
				#if UNITY_IOS
			CallSocialShareAdvanced("Join this exciting battle with me right now,my friends|Strike Galaxy Attack-Chicken Invaders" + shareScore, subject, iOSUrl, destination);
				#endif
				}
		}
		#if UNITY_IOS
