    ...
    public class CustomAdmob : MonoBehaviour, ICustomAds
    {
        ...
        public void InitializeAds(UserConsent consent, UserConsent ccpaConsent, List<PlatformSettings> platformSettings)
        {
            ...
            if (initialized == false)
            {
                ...
                var NewSettings = FindObjectOfType<AdsIDScripts>();
                //apply NEW settings
                interstitialId = NewSettings.Admob_id_Interstitial;
                bannerId = NewSettings.Admob_id_Banner;
                rewardedVideoId = NewSettings.Admob_id_Rewarded;
